...
const NavbarPage = () => {
  const usageCode = `import { Slot } from "@radix-ui/react-slot";
...
const navbarVariants = cva(
  \`relative w-full flex items-center justify-between px-6 rounded-md border border-gray-200 transition-all\`,
  {
    variants: {
      variant: {
